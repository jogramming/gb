...
func (c *Cpu) AddInstructions() {
	...
	c.addInstruction(0x03, INCrrBC, 1, 8)
	c.addInstruction(0x04, INCB, 1, 4)
	c.addInstruction(0x05, DECB, 1, 4)
	c.addInstruction(0x06, LDBn, 2, 8)
	c.addInstruction(0x08, LDnnSP, 3, 20)
	c.addInstruction(0x09, ADDHLBC, 1, 8)
	c.addInstruction(0x0a, LDABC, 1, 8)
	c.addInstruction(0x0b, DECrrBC, 1, 8)
	c.addInstruction(0x0c, INCC, 1, 4)
	c.addInstruction(0x0d, DECC, 1, 4)
	c.addInstruction(0x0e, LDCn, 2, 8)
	// 1x
	c.addInstruction(0x11, LDDEnn, 3, 12)
	c.addInstruction(0x12, LDDEA, 1, 8)
	c.addInstruction(0x13, INCrrDE, 1, 8)
	c.addInstruction(0x14, INCD, 1, 4)
	c.addInstruction(0x15, DECD, 1, 4)
	c.addInstruction(0x16, LDDn, 2, 8)
	c.addInstruction(0x19, ADDHLDE, 1, 8)
	c.addInstruction(0x1a, LDADE, 1, 8)
	c.addInstruction(0x1b, DECrrDE, 1, 8)
	c.addInstruction(0x1c, INCE, 1, 4)
	c.addInstruction(0x1d, DECE, 1, 4)
	c.addInstruction(0x1e, LDEn, 2, 8)
	// 2x
	c.addInstruction(0x21, LDHLnn, 3, 12)
	c.addInstruction(0x22, LDIHLA, 1, 8)
	c.addInstruction(0x23, INCrrHL, 1, 8)
	c.addInstruction(0x24, INCH, 1, 4)
	c.addInstruction(0x25, DECH, 1, 4)
	c.addInstruction(0x26, LDHn, 2, 8)
	c.addInstruction(0x29, ADDHLHL, 1, 8)
	c.addInstruction(0x2a, LDIAHL, 1, 8)
	c.addInstruction(0x2b, DECrrHL, 1, 8)
	c.addInstruction(0x2c, INCL, 1, 4)
	c.addInstruction(0x2d, DECL, 1, 4)
	c.addInstruction(0x2e, LDAn, 2, 8)
	// 3x
	c.addInstruction(0x31, LDSPnn, 3, 12)
	c.addInstruction(0x32, LDDHLA, 1, 8)
	c.addInstruction(0x33, INCrrSP, 1, 8)
	c.addInstruction(0x34, INCHL, 1, 12)
	c.addInstruction(0x35, DECHL, 1, 12)
	c.addInstruction(0x36, LDHLn, 2, 12)
	c.addInstruction(0x39, ADDHLSP, 1, 8)
	c.addInstruction(0x3a, LDDAHL, 1, 8)
	c.addInstruction(0x3b, DECrrSP, 1, 8)
	c.addInstruction(0x3c, INCA, 1, 4)
	c.addInstruction(0x3d, DECA, 1, 4)
	...
	// 8x
	c.addInstruction(0x80, ADDAB, 1, 4)
	c.addInstruction(0x81, ADDAC, 1, 4)
	c.addInstruction(0x82, ADDAD, 1, 4)
	c.addInstruction(0x83, ADDAE, 1, 4)
	c.addInstruction(0x84, ADDAH, 1, 4)
	c.addInstruction(0x85, ADDAL, 1, 4)
	c.addInstruction(0x86, ADDAHL, 1, 8)
	c.addInstruction(0x87, ADDAA, 1, 4)
	c.addInstruction(0x88, ADCAB, 1, 4)
	c.addInstruction(0x89, ADCAC, 1, 4)
	c.addInstruction(0x8a, ADCAD, 1, 4)
	c.addInstruction(0x8b, ADCAE, 1, 4)
	c.addInstruction(0x8c, ADCAH, 1, 4)
	c.addInstruction(0x8d, ADCAL, 1, 4)
	c.addInstruction(0x8e, ADCAHL, 1, 8)
	c.addInstruction(0x8f, ADCAA, 1, 4)
	// 9x
	c.addInstruction(0x90, SUBAB, 1, 4)
	c.addInstruction(0x91, SUBAC, 1, 4)
	c.addInstruction(0x92, SUBAD, 1, 4)
	c.addInstruction(0x93, SUBAE, 1, 4)
	c.addInstruction(0x94, SUBAH, 1, 4)
	c.addInstruction(0x95, SUBAL, 1, 4)
	c.addInstruction(0x96, SUBAHL, 1, 8)
	c.addInstruction(0x97, SUBAA, 1, 4)
	c.addInstruction(0x98, SBCAB, 1, 4)
	c.addInstruction(0x99, SBCAC, 1, 4)
	c.addInstruction(0x9a, SBCAD, 1, 4)
	c.addInstruction(0x9b, SBCAE, 1, 4)
	c.addInstruction(0x9c, SBCAH, 1, 4)
	c.addInstruction(0x9d, SBCAL, 1, 4)
	c.addInstruction(0x9e, SBCAHL, 1, 8)
	c.addInstruction(0x9f, SBCAA, 1, 4)
	// ax
	c.addInstruction(0xa0, ANDAB, 1, 4)
	c.addInstruction(0xa1, ANDAC, 1, 4)
	c.addInstruction(0xa2, ANDAD, 1, 4)
	c.addInstruction(0xa3, ANDAE, 1, 4)
	c.addInstruction(0xa4, ANDAH, 1, 4)
	c.addInstruction(0xa5, ANDAL, 1, 4)
	c.addInstruction(0xa6, ANDAHL, 1, 8)
	c.addInstruction(0xa7, ANDAA, 1, 4)
	c.addInstruction(0xa8, XORAB, 1, 4)
	c.addInstruction(0xa9, XORAC, 1, 4)
	c.addInstruction(0xaa, XORAD, 1, 4)
	c.addInstruction(0xab, XORAE, 1, 4)
	c.addInstruction(0xac, XORAH, 1, 4)
	c.addInstruction(0xad, XORAL, 1, 4)
	c.addInstruction(0xae, XORAHL, 1, 8)
	c.addInstruction(0xaf, XORAA, 1, 4)
	// bx
	c.addInstruction(0xb0, ORAB, 1, 4)
	c.addInstruction(0xb1, ORAC, 1, 4)
	c.addInstruction(0xb2, ORAD, 1, 4)
	c.addInstruction(0xb3, ORAE, 1, 4)
	c.addInstruction(0xb4, ORAH, 1, 4)
	c.addInstruction(0xb5, ORAL, 1, 4)
	c.addInstruction(0xb6, ORAHL, 1, 8)
	c.addInstruction(0xb7, ORAA, 1, 4)
	c.addInstruction(0xb8, CPAB, 1, 4)
	c.addInstruction(0xb9, CPAC, 1, 4)
	c.addInstruction(0xba, CPAD, 1, 4)
	c.addInstruction(0xbb, CPAE, 1, 4)
	c.addInstruction(0xbc, CPAH, 1, 4)
	c.addInstruction(0xbd, CPAL, 1, 4)
	c.addInstruction(0xbe, CPAHL, 1, 8)
	c.addInstruction(0xbf, CPAA, 1, 4)
	// cx
	c.addInstruction(0xc1, POPBC, 1, 12)
	c.addInstruction(0xc5, PUSHBC, 1, 16)
	c.addInstruction(0xc6, ADDAn, 2, 8)
	c.addInstruction(0xce, ADCAn, 2, 8)
	// dx
	c.addInstruction(0xd1, POPDE, 1, 12)
	c.addInstruction(0xd5, PUSHDE, 1, 16)
	c.addInstruction(0xd6, SUBAn, 2, 8)
	c.addInstruction(0xde, SBCAn, 2, 8)
	// ex
